'''
Module 2: Scenario-Situation Constructor - American/Violation
...
# Load CSV dataset
file_path = 'YOUR_PATH/situation_american_violation.csv'
...
new_df.to_csv("situation_american_violation.csv", index=False, encoding="utf-8-sig")